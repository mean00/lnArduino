...
pub struct lnfast_event_group_c {
    pub dummy: *mut cty::c_void,
}
unsafe extern "C" {
    pub fn lnfast_event_group_create() -> *mut lnfast_event_group_c;
}
unsafe extern "C" {
    pub fn lnfast_event_group_delete(arg1: *const lnfast_event_group_c);
}
unsafe extern "C" {
    pub fn lnfast_event_group_takeOwnership(inst: *const lnfast_event_group_c);
}
unsafe extern "C" {
    pub fn lnfast_event_group_set_events(inst: *const lnfast_event_group_c, event: cty::c_uint);
}
unsafe extern "C" {
    pub fn lnfast_event_group_wait_events(
        inst: *const lnfast_event_group_c,
        mask: cty::c_uint,
        timeout: i32,
    ) -> cty::c_uint;
}
unsafe extern "C" {
    pub fn lnfast_event_group_read_events(
        inst: *const lnfast_event_group_c,
        mask: cty::c_uint,
    ) -> cty::c_uint;
}
