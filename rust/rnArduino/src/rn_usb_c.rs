...
pub type lnUsbStackEventHandler = ::core::option::Option<
    unsafe extern "C" fn(cookie: *mut core::ffi::c_void, event: core::ffi::c_int),
>;
#[repr(C)]
...
extern "C" {
    pub fn lnusb_create(instance: core::ffi::c_uint) -> *mut lnusb_c;
}
extern "C" {
...
extern "C" {
    pub fn lnusb_init(
        inst: *mut lnusb_c,
        nbDescriptorLine: core::ffi::c_int,
        deviceDescriptor: *mut *const core::ffi::c_char,
    );
}
extern "C" {
