...
pub const tskKERNEL_VERSION_NUMBER: &[u8; 8usize] = b"V10.5.1\0";
...
impl lnGpioMode {
    pub const lnINPUT_FLOATING: lnGpioMode = lnGpioMode::lnFLOATING;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum lnGpioMode {
...
extern "C" {
    #[link_name = "\u{1}_Z9lnPinMode5lnPin10lnGpioMode"]
    pub fn lnPinMode(pin: lnPin, mode: lnGpioMode);
}
extern "C" {
