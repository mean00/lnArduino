...
extern "C" {
    ...
    pub fn xBinarySemaphore_take1(this: *mut xBinarySemaphore, timeoutMs: cty::c_int) -> bool;
}
extern "C" {
...
pub type lnSerial_txMode = cty::c_uint;
extern "C" {
...
extern "C" {
    ...
    pub fn lnSerial_transmit(this: *mut lnSerial, size: cty::c_int, buffer: *mut u8) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN8lnSerial11dmaTransmitEiPh"]
    pub fn lnSerial_dmaTransmit(this: *mut lnSerial, size: cty::c_int, buffer: *mut u8) -> bool;
}
extern "C" {
...
extern "C" {
    ...
    pub fn lnSerial_lnSerial(this: *mut lnSerial, instance: cty::c_int);
}
impl lnSerial {
    #[inline]
    ...
    #[inline]
    pub unsafe fn transmit(&mut self, size: cty::c_int, buffer: *mut u8) -> bool {
        lnSerial_transmit(self, size, buffer)
    }
    #[inline]
    pub unsafe fn dmaTransmit(&mut self, size: cty::c_int, buffer: *mut u8) -> bool {
...
extern "C" {
    ...
    pub fn lnTimer_setPwmMode(this: *mut lnTimer, ratio1024: cty::c_int);
}
extern "C" {
...
extern "C" {
    ...
    pub fn lnTimer_setChannelRatio(this: *mut lnTimer, ratio1024: cty::c_int);
}
extern "C" {
...
impl lnTimer {
    #[inline]
    pub unsafe fn setPwmMode(&mut self, ratio1024: cty::c_int) {
    ...
    #[inline]
    pub unsafe fn setChannelRatio(&mut self, ratio1024: cty::c_int) {
