...
#include "simplerAD8933_internal.h"
#if 0
 ...
 * @param onoff
 */
void      simplerAD8933::digitalWrite(int pin, bool onoff)
{
    int msk=1<<pin;
    if(onoff) 
        PortBValue|=msk;
 ...
 * @return 
 */
bool          simplerAD8933::readOutput(int pin)
{
 ...
 * @return 
 */
bool        simplerAD8933::readInput(int pin)
{
 ...
 * @return 
 */
bool        simplerAD8933::dumpRegisters()
{
    uint8_t reg;
  //  for(int i=0;i<27;i++)
    for(int i=0;i<27;i++)
