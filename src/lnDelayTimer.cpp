...
void TIMER1_IRQHandler(){    lnDelayTimer::interruptHandler(1);}
void TIMER2_IRQHandler(){    lnDelayTimer::interruptHandler(2);}
void TIMER3_IRQHandler(){    lnDelayTimer::interruptHandler(3);}
void TIMER4_IRQHandler(){    lnDelayTimer::interruptHandler(4);}
//EOF
