 ...
 * \details
 *
 * The NMSIS-Core provides the header file <b>nmsis_compiler.h</b> with consistent \#define symbols for generate C or
 * C++ source files that should be compiler agnostic. Each NMSIS compliant compiler should support the functionality
 * described in this section.
 *
 * The header file <b>nmsis_compiler.h</b> is also included by each Device Header File <device.h> so that these
