...
MACRO(GENERATE_GD32_FIRMWARE target)
  ...
  IF(NOT LN_MCU_RAM_SIZE)
    ...
    configure_file( "${AF_FOLDER}/riscv_ch32v3x/boards/ch32v3x/clang.lld.in" "${CMAKE_BINARY_DIR}/linker_script.ld" @ONLY)
    ...
    TARGET_LINK_LIBRARIES(${target} embeddedPrintf gd32_overlay gd32Arduino   FreeRTOS  gd32_lowlevel c   ) # dupicates are NOT a mistake !
