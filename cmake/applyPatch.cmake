...
MACRO(APPLY_PATCH_IF_NEEDED markerFile patchFile subdir description)
  ...
  IF(NOT EXISTS "${CMAKE_SOURCE_DIR}/${subdir}/${markerFile}")
      ...
      file(WRITE "${CMAKE_SOURCE_DIR}/${subdir}/${markerFile}" "patched")
  ENDIF(NOT EXISTS "${CMAKE_SOURCE_DIR}/${subdir}/${markerFile}")
