IF(NOT Rust_CARGO_TARGET)
  IF(LN_ARCH STREQUAL "RISCV")
    IF(USE_HW_FPU)
      SET(Rust_CARGO_TARGET "${LNARDUINO_ROOT}/mcus/riscv_ch32v3x/riscv32imacf-unknown-none-elf.json" CACHE INTERNAL "")
  ...
  ELSE()
    IF(LN_ARCH STREQUAL "ARM")
      IF("${LN_MCU}" STREQUAL "M4")
        #SET(Rust_CARGO_TARGET "${LNARDUINO_ROOT}/arm_gd32fx/thumbv7em-none-eabihf.json" CACHE INTERNAL "")
        #SET(LN_RUST_BUILD_FLAGS  -Z build-std=core,alloc CACHE INTERNAL "")
        SET(Rust_CARGO_TARGET "thumbv7em-none-eabihf" CACHE INTERNAL "")
      ELSEIF("${LN_MCU}" STREQUAL "M3")
        #SET(Rust_CARGO_TARGET "${LNARDUINO_ROOT}/arm_gd32fx/thumbv7m-none-eabi.json" CACHE INTERNAL "")
        #SET(LN_RUST_BUILD_FLAGS  -Z build-std=core,alloc CACHE INTERNAL "")
...
#
ADD_SUBDIRECTORY(${LNARDUINO_ROOT}/rust/corrosion corrosion)
#
#
