...
IF(0)
    # Nuclei version
    SET(LN_FREERTOS_PORT ${ARDUINO_GD32_FREERTOS}/riscv/freeRTOS_extension/N200_nuclei CACHE INTERNAL "")
...
ELSE()
    # QQ version
    SET(LN_FREERTOS_PORT ${ARDUINO_GD32_FREERTOS}/riscv/freeRTOS_extension/N200 CACHE INTERNAL "")
