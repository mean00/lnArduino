...
/* R8_UH_RX_CTRL */
// meanx #define USBHS_UH_R_DATA_NO 0x40
// meanx #define USBHS_UH_R_TOG_AUTO 0x20
...
#//meanx define USBHS_UH_R_RES_NO 0x04
...
/* R8_UH_TX_CTRL */
// meanx #define USBHS_UH_T_DATA_NO 0x40
...
// meanx #define USBHS_UH_T_RES_NO 0x04
// meanx #define USBHS_UH_T_RES_MASK 0x03
// meanx #define USBHS_UH_T_RES_ACK 0x00
// meanx #define USBHS_UH_T_RES_NYET 0x01
// meanx #define USBHS_UH_T_RES_NAK 0x02
// #meanx define USBHS_UH_T_RES_STALL 0x03
...
#define USBFS_UIF_HST_SOF                                                                                              \
    0x08 // host SOF timer interrupt flag for USB host, direct bit address clear or write 1 to clear
#define USBFS_UIF_SUSPEND                                                                                              \
    0x04 // USB suspend or resume event interrupt flag, direct bit address clear or write 1 to clear
...
#define USBFS_UIF_DETECT                                                                                               \
    0x01 // device detected event interrupt flag for USB host mode, direct bit address clear or write 1 to clear
#define USBFS_UIF_BUS_RST                                                                                              \
    0x01 // bus reset event interrupt flag for USB device mode, direct bit address clear or write 1 to clear
...
#define USBFS_UIS_H_RES_MASK                                                                                           \
    0x0F // RO, bit mask of current transfer handshake response for USB host mode: 0000=no response, time out from
         // device, others=handshake response PID received
...
#define USBFS_UEP_T_AUTO_TOG                                                                                           \
    0x08 // enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic
         // toggle
...
#define USBFS_UH_R_AUTO_TOG                                                                                            \
    0x08 // enable automatic toggle after successful transfer completion: 0=manual toggle, 1=automatic toggle
#define USBFS_UH_R_TOG 0x04 // expected data toggle flag of host receiving (IN): 0=DATA0, 1=DATA1
#define USBFS_UH_R_RES                                                                                                 \
    0x01 // prepared handshake response type for host receiving (IN): 0=ACK (ready), 1=no response, time out to device,
         // for isochronous transactions
...
#define USBFS_UH_T_RES                                                                                                 \
    0x01 // expected handshake response type for host transmittal (SETUP/OUT): 0=ACK (ready), 1=no response, time out
         // from device, for isochronous transactions
