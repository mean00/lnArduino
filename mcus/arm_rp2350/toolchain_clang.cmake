...
IF(NOT DEFINED LN_EXT)
  ...
  SET(GD32_MCU "-mcpu=cortex-m33 --target=armv8m-none-eabi -DPICO_RP2350=1  -DPICO_PLATFORM=rp2350 -DUSE_RP2350 -DPICO_RP2350_USB_FAST_IRQ=0  " CACHE INTERNAL "")
  ...
  SET(GD32_RP_FLAGS "${GD32_RP_FLAGS} -I${PICO_SDK_PATH}/src/common/pico_base_headers/include/ -I${PICO_SDK_PATH} -I${PICO_SDK_PATH}/src/rp2350/pico_platform/include/ -I${PICO_SDK_PATH}src/rp2_common/pico_platform_panic/include")
  SET(GD32_RP_FLAGS "${GD32_RP_FLAGS} -I${PICO_SDK_PATH}/src/rp2_common/pico_platform_compiler/include")
  SET(GD32_RP_FLAGS "${GD32_RP_FLAGS} -I${PICO_SDK_PATH}/src/rp2350/hardware_regs/include/ -I${PICO_SDK_PATH}/src/rp2_common/pico_platform_sections/include/")
  SET(GD32_RP_FLAGS "${GD32_RP_FLAGS} -I${PICO_SDK_PATH}/src/rp2_common/pico_platform_panic/include/ -I${PICO_SDK_PATH}/src/rp2_common/hardware_sync/include")
  SET(GD32_RP_FLAGS "${GD32_RP_FLAGS} -I${PICO_SDK_PATH}/src/rp2_common/hardware_base/include -I${PICO_SDK_PATH}/src/rp2350/hardware_structs/include -I${PICO_SDK_PATH}/src/rp2_common/hardware_sync_spin_lock/include/")
