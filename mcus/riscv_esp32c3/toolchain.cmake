...
IF(NOT DEFINED LN_EXT)
  ...
  SET(LN_TOOLCHAIN_EXT  riscv_esp32c3 CACHE INTERNAL "")
  ...
  MESSAGE(STATUS "ESP32C3 C   compiler ${CMAKE_C_COMPILER}")
  MESSAGE(STATUS "ESP32C3 C++ compiler ${CMAKE_CXX_COMPILER}")
  IF(LN_SPEC)
  ...
  #
  SET(GD32_SPECS_C_FLAGS  "${GD32_SPECS}  ${MCPU} ${GD32_DEBUG_FLAGS} ${PLATFORM_C_FLAGS} -DLN_MCU=LN_MCU_ESP32C3 -DLN_ARCH=LN_ARCH_RISCV -Werror=return-type  -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common ${GD32_BOARD_FLAG} -I${AF_FOLDER}/riscv_esp32c3/" CACHE INTERNAL "")
