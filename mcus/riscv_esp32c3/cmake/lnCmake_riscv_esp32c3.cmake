...
MACRO(GENERATE_GD32_FIRMWARE target)
  ...
  IF(USE_ESP32C3_PURe_RAM)
    configure_file( "${LN_MCU_FOLDER}/boards/esp32c3/ld_ram.lds.in" "${CMAKE_BINARY_DIR}/linker_script.ld" @ONLY)
  ELSE()
    configure_file( "${LN_MCU_FOLDER}/boards/esp32c3/ld.lds.in" "${CMAKE_BINARY_DIR}/linker_script.ld" @ONLY)
  ENDIF()
